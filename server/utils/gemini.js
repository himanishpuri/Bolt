...
SENTIMENT: [positive/negative/neutral]`;
      ...
      console.error(`Error getting stock news analysis for ${ticker}:`, error);
  ...
  async getEducationalContent(topic) {
    try {
      ...
      console.error(`Error getting educational content for ${topic}:`, error);
  ...
  async processMultipleEducationalTopics(topics) {
    ...
    for (const topic of topics) {
      try {
        ...
        console.error(`Error processing educational topic ${topic}:`, error);
        results.push({
          topic: topic,
